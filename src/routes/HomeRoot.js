            ...
            return (
              ...
              >
                ...
                {/* <AntDesign
                  ...
                  color={focused ? "#29C752" : "rgba(0, 0, 0, 0.7)"}
                /> */}
                <Fontisto name="favorite" size={24} color={focused ? "#29C752" : "rgba(0, 0, 0, 0.7)"} />
        ...
        options={{
          tabBarIcon: ({ focused }) => {
            return (
              ...
              >
                {focused ? (
                  <Ionicons name="ios-apps" size={32} color="#FFF" />
                ) : (
                  <Ionicons name="ios-apps-outline" size={30} color="#FFF" />
                )}
                {/* <Ionicons
                  name="ios-menu"
                  size={35}
